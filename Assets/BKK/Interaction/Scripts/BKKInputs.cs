...
//     version 1.2.0
//     from Assets/BKK/Interaction/Scripts/BKKInputs.inputactions
//
...
public partial class @BKKInputs : IInputActionCollection2, IDisposable
{
    ...
    {
        private @BKKInputs m_Wrapper;
        public PlayerActions(@BKKInputs wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @BKKInputs m_Wrapper;
        public TouchActions(@BKKInputs wrapper) { m_Wrapper = wrapper; }
